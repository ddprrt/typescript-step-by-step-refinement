...
type AppRequest<Method extends HttpMethods> = {
  method: Method
...
type CallbackFn<Method extends HttpMethods>
  = (req: AppRequest<Method>, res: AppResponse) => void;

function get(path: string, cb: CallbackFn<"GET">) {
